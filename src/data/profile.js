 ...
 * Contains verified biographical and contact information for Ayyaj Kalandar Shaikh.
 */

export const profileData = {
  name: "Ayyaj Kalandar Shaikh",
  shortName: "Ayyaj Shaikh",
  title: "Software Developer & Full Stack Engineer",
  headline: "Java • Spring Boot • React.js • ASP.NET Core • Cloud Computing",
  currentRole: "MERN Stack + AI Intern @ BQARLSON Software Pvt. Ltd.",
  educationDegree: "Master of Computer Applications (MCA)",
...
/**
 * Dedicated Recruiter Profile Configuration
 * Streamlined summary and high-priority decision metrics.
 */
export const recruiterProfile = {
  ...
  availability: "Immediate / Notice-free for Software Developer & Engineering roles",
  targetRoles: ["Full Stack Developer", "Software Developer", "Java Backend Developer", "Cloud Engineer"],
  highlights: [
